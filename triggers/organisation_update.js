...
module.exports = {
  operation: {
    outputFields: [
      ...
      { key: 'members[]primary_address__city', label: 'Primary Address City' },
      { key: 'members[]primary_address__name', label: 'Primary Address Name' },
    ...
    performList: {
      body: {},
      url:
        'https://api.current-rms.com/api/v1/members?page=1&per_page=20&filtermode=all&view_id=1',
      removeMissingValuesFrom: {},
      headers: {
        Accept: 'application/json',
        'X-APIKEY': '{{bundle.authData.apikey}}',
